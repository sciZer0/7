...
The blockchain strives to constantly give only highly-generous automated-donations in the native token to each Contributor (software engineer) contributing to the U blockchain (initially to the U DAO) — at least, **$1,2 million per year** or **$100,000 per month**.
