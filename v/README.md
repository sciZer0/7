...
Hyde Park is a set of internet platforms and protocols (incl. Twitter, Telegram, Discord, Nostr, Vote) that might be used for expressing various opinions and discussing proposals, including, proposals on appointing/dismissing.
...
*Flexing as a culture, in a broad sense, might be described as showing that you are better than other people since you may do (have) the thing everyone else cannot do (have) — specifically, it happens through extremal money spending. This is the demonstration of domination, superiority.*
