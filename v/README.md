...
Ideally, a blockchain must create extremely-generous long-term incentives for validators and developers when calculated per person — in order to be a more sustainable working system.
...
<i><b>Flexing as a culture, in a broad sense, might be described as showing that you are better than other people since you can do/have the thing other people cannot do/have. For example, this may happen through creating a unique thing (token), or on the other hand, through spending significant money on a unique thing (token) proving your involvement with a unique (sometimes historical) event. Essentially, this is a way for anyone to demonstrate their domination, superiority. Also, the flexing is the thing that moves progress, since it gives motivation to people to do/create impossible, unique things, or on the other hand, to financially support this all. And plus of course, this does not exclude making money through reselling a unique thing (token) to another one.</b></i>
...
In a world of exchanges and aggregators of exchanges, there is one thing to always keep in mind — the thing was said by the most technically-advanced people in the industry, including Anatoly Yakovenko — <b>sharding sucks</b>. Importantly, even <b>sharding sucks</b>, not to mention Layer 2 solutions built over sharding.
