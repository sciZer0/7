...
But if you are ready to get permission access to value, you don't need a blockchain — maybe you need some token with low inflation like BTC or ETH has, but you don't  need a blockchain.
...
The Decreasing-Supply, permissionless, decentralized Token is the thing our civilization has never known and felt before — it is fundamentally even better than digital gold or digital diamonds.
...
But why were many fundamental problems of Bitcoin – including the terrible Gini and extremal inefficiency – most likely predefined?
...
Ideally, a blockchain must create extremely-generous long-term incentives for validators and developers when calculated per person — in order to always be able to attract the brightest engineers from both Web2 and Web3, and as a result, to always be a sustainable working system.
...
<p>
<b>
This is a blockchain which is extremely hard to surpass/improve in terms of maximization of decentralization, efficiency, justice and opportunities for developers.
</b>
</p>
<p>&nbsp</p>
...
Some believe that Bitcoin has its value because Bitcoin is lots of lots of pure energy converted into a digital monetary instrument via the mining process. But in reality, inefficient (expensive) consensus does never add the value to a blockchain because inefficient  consensus does never increase the consumer value of the blockchain.
