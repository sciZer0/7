...
Plus, importantly, if you wish the roller coaster to users' money then you use smart contracts for solving fundamental tasks like trastless stablecoins and trastless bridges, but if you wish safety to users' money then you use the blockchain's codebase for solving these fundamental tasks.
