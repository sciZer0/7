...
We should form Creator Thanksgiving Culture to give thanks in tokens (donations) to creators of digitizable things, incl. to creators of ideas and code. Also, through buying NFTs of the creators.<br>
...
Summarizing, when people create something digitizable (incl. idea/code), there must be absolute freedom for everyone to surpass it — to improve it — on their own.
...
Plus, the Bitcoin blockchain has the irremovable fundamental flaws, including the absolutely-terrible Gini and extreme inefficiency, including extremaly-low bandwidth.  
