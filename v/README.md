...
Also for the first time ever, the blockchain has the native token, the total-supply of which is decreasing from day one, and plus, the blockchain, being highly-decentralized, is both highly-sustainable and unprecedentedly highly-efficient simultaneously.
...
* be a highly-decentralized system of many incentivized, autonomous nodes.
...
It is because technically, anyone can upload any known digitizable things: videos, audios, texts, programs (being in reality just numbers) on a blockchain and then allow people to **permissionlessly** access/use these things (these numbers) when they want.

For example, if the uploader wants, he/she can give **permissionless access** to uploaded digitizable things to all people around the world, and no one can prevent people from accessing/using these things (videos, audios, texts, programs) when they want.
...
Fundamental Problem 2 is that on each of the existing blockchains, there is the great unfairness — meaning, the most tokens of the blockchain are distributed to a small number of people.
