...
Surely, the industry needs the really locomotive blockchain in order for everything else to be built on and around it. And it is not the Bitcoin blockchain and not the Ethereum Blockchain or any other blockchain you know, it is something fundamentally new.
...
*Plus, to all Bitcoiners, this is important to keep in mind that by assuming that the Bitcoin blockchain will forever be the most successful one in the crypto industry, you deny the ability of our civilization to progress — incl. progress drastically.*
