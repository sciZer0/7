...
This paper proposes an idea (set of ideas/solutions/approaches) on a highly-efficient blockchain protocol that might solve all the fundamental problems and enable mass adoption for crypto.
