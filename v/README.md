...
Summarizing, when people create something that may be digitalized (incl. idea/code), there must be absolute freedom for everyone to surpass it — to improve it.
