...
Also, the blockchain constantly gives highly-generous automated-donations in the native token, ~ **$1,2 million per year** or **$100,000 per month**, to each developer (programming engineer) contributing to the Vote blockchain — or/and initially to the Vote DAO.
