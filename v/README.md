...
Also for the first time ever,  the blockchain does the most desirable and simultaneously impossible thing in the industry. Specifically, the blockchain introduces and has the **native token**, the total-supply of which is constantly decreasing from day one.
