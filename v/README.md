...
*Plus, this is important to keep in mind, by recognizing that the Bitcoin blockchain will forever be  the most successful one in the crypto industry, we deny the ability of our civilization to progress.*
...
Importantly, even though the main principle of democracy is that each Voter has absolute freedom to either vote or not, and plus, a Voter might spend only their idle time on voting, nevertheless at best, massive competitive-votings, happening on the Vote blockchain, might additionally decrease the Vote token's real circulating supply significantly — of course, resulting in an additional rise in the voting power of the Vote token.
</b></i>
