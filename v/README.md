...
By the way, total immutability is especially not good for smart-contracts being built on and sometimes connected to changeable blockchains since if any bugs are discovered in the immutable code, they cannot be fixed and users can lose all of their funds. But , the changeability of smart-contracts involve, among other things, multisigs of some people  that causes already other problems. *A little more on problems of smart-contracts and solutions a bit below.*
