...
Thanks to the native token with the decreasing total-supply, the blockchain creates the most valuable one in the Universe: **the token with the constantly-increasing scarcity**. 
