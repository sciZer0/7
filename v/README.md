...
Some parts of the idea — absence of which is not preventing from understanding the the idea as a whole — are hidden, and will only be revealed to Contributors of the Vote DAO starting the Vote blockchain.
