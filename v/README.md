...
Also, with blockchain technology, people can establish highly-efficient states creating outstandingly-good conditions for both people (themselves) and businesses simultaneously — including, for example, cardinal cut of tax burden (-95%), cancellation of all traditional taxes and introduction of only a small number of innovative taxes (self-collected, privacy-preserving ones).
