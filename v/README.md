...
This paper proposes an idea about a revolutionary blockchain with the native, decreasing-total-supply token. 

The blockchain is highly-sustainable and highly-efficient simultaneously.

Having unprecedented advantages and being especially-suitable for mass adoption, the blockchain might be the 1st one to achieve the market capitalization of **$20 trillion** and allow at least **100,000,000 people** from around the world to make life-changing money from investing no money — not to mention billions of people also able to benefit from it. 
