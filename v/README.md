...
On the other hand, the main task of developers is to build/make such systems as reliable, fast, secure, decentralized, sustainable  and, of course, efficient as possible.
...
On other blockchains, the conditiothe aren't much better, if any better.
...
It is just a matter of time that some initiative group of people will create a blockchain of that sort. This might even be VCs realizing their humanitarian missions.
